...
{
    /// <inheritdoc />
    public partial class AddWorkoutPlanner : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkoutPlanDayId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutPlanDays_WorkoutPlanId_DayIndex",
                table: "WorkoutPlanDays",
                columns: new[] { "WorkoutPlanId", "DayIndex" },
                unique: true);
