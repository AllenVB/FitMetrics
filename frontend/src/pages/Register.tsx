...
import { Button, ErrorAlert, Field, Icon, Input, Select } from '../components/ui';
...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-2xl clean-card rounded-2xl p-8 shadow-2xl">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-body-sm text-on-surface-variant">Hesap oluştur ve hedefini belirle</p>
        </div>
        ...
        <p className="mt-6 text-center text-body-sm text-on-surface-variant">
          ...
          <Link to="/login" className="font-semibold text-primary hover:underline">Giriş yap</Link>
        </p>
      </div>
    </div>
  );
